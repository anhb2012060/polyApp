...
public class LoginDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jButton_DangNhap.setFont(new java.awt.Font("Segoe UI", 0, 13)); // NOI18N
        ...
        jButton_Thoat.setFont(new java.awt.Font("Segoe UI", 0, 13)); // NOI18N
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(jButton_DangNhap, javax.swing.GroupLayout.PREFERRED_SIZE, 94, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jButton_Thoat, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/mycompany/icon/student.png"))); // NOI18N
    ...
    private void jButton_DangNhapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_DangNhapActionPerformed
        ...
        DataValidator.validatorEmpty(jTextField_TenDangNhap,sb, "Tên đăng nhập không được để trống!");
        DataValidator.validatorEmpty(jPasswordField_MatKhau, sb, "Mật khẩu không được để trống!");
        if(sb.length() > 0){
            MessageDialogHelper.showErrorDialog(this,sb.toString(), "Lổi");
            return;
        }
        
        //Phải chuyển mật khẩu thành kiểu String mới sử dụng được:
        NguoiDung nd = NguoiDungDao.checkLogin(jTextField_TenDangNhap.getText(), new String(jPasswordField_MatKhau.getPassword()));
        
        if(nd == null){
            MessageDialogHelper.showErrorDialog(this, "Tên đăng nhập hoặc mật khẩu không đúng", "Lổi");
        } else {
